...
export const EditCardModal: React.FC<EditCardModalProps> = ({
    ...
    const hasChanges = name !== card.name || 
                    ...
                    <div className="p-6 border-b border-gray-200 bg-gray-50">
                        <div className="flex items-start justify-between gap-6">
                            ...
                            <div className="text-sm text-gray-600 space-y-1">
                                ...
                                <div>
                                    <span className="font-medium">Plats originaux:</span> {card.dishesId.length}
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex justify-between items-center">
                            ...
                            <div className="flex gap-3">
                                ...
                                <button
                                    ...
                                    disabled={isSubmitting || !name.trim() || selectedDishes.size === 0 || !hasChanges}
                ...
                <div className="p-6">
                    ...
                    <div className="mb-6">
                        <p className="text-gray-600 mb-2">
                            Êtes-vous sûr de vouloir supprimer la carte <strong>"{card.name}"</strong> ?
                        </p>
                        <p className="text-sm text-red-600 bg-red-50 p-3 rounded-lg">
                            ⚠️ Cette action est irréversible et supprimera définitivement la carte.
                        </p>
                    </div>
