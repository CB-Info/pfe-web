        ...
        <div className="flex-1 overflow-y-auto bg-gray-50">
          {isLoading ? (
            <div className="flex flex-1 items-center justify-center h-full">
              <Loading size="medium" text="Chargement des cartes..." />
            </div>
          ) : (
...
const CardItem: React.FC<CardItemProps> = ({
  ...
  return (
    <div
      className={`p-4 flex flex-col h-48 transition-all duration-300 relative group ${
        isActive ? "bg-blue-50" : ""
      }`}
    >
      ...
      <div className="flex items-center justify-between pt-2 border-t">
        <span
          className={`text-sm ${
            card.isActive ? "text-blue-600 font-medium" : "text-gray-600"
          }`}
        >
